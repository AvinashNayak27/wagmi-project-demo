...
const baseColorsAbi = [
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "tokenId", type: "uint256" },
      { internalType: "string[]", name: "traitTypes", type: "string[]" },
  ...
  },
  {
    inputs: [
      { internalType: "string", name: "traitType", type: "string" },
      { internalType: "bool", name: "isUserModifiable", type: "bool" },
      { internalType: "bool", name: "isEnabledForAllTokens", type: "bool" },
      { internalType: "uint256[]", name: "eligibleTokens", type: "uint256[]" },
    ],
  ...
  {
    inputs: [{ internalType: "string", name: "traitType", type: "string" }],
...
function App() {
  ...
  const randomName = randomColor.toUpperCase().substring(1);
